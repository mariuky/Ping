...
//Color por defecto
var color1= 'assets/images/raqueta1.png';
var color2= 'assets/images/raqueta1.png';
...
Ping.customizeState.prototype = {
    ...
    updateColorBlue: function(){
        ...
        color1='assets/images/raqueta_azul.png';
    },
    updateColorRed: function(){
        numeroColor=2;
        colorRaqueta = 'raquetaRed';
        color1='assets/images/raqueta_roja.png';
    },
    updateColorYellow: function(){
        numeroColor=3;
        colorRaqueta = 'raquetaYellow';
        color1='assets/images/raqueta_amarilla.png';
    },
    updateColorGreen: function(){
        numeroColor=4;
        colorRaqueta = 'raquetaGreen';
        color1='assets/images/raqueta_verde.png';
    },
    drawPlayer: function(){
        palas.destroy();
        palas2.destroy();
